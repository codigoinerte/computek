<nav
	...
	<div class="flex items-center gap-2">
	<a class="pointer-events-none text-slate-400" href="#">Promociones</a>
	</div>
</nav>
<section class="container mx-auto px-4 sm:px-8 xl:px-4">
	<div class="mb-6 grid grid-cols-6 gap-7">
        ...
        $contar_categorias = $datos_reg_home->contar_destacados();
        ...
        ###########################################################################################
        $lproductos = $datos_reg_home->listar_destacados($limitInf,$tamPag);		
        ################################DISEÑO DE CATALOGO#########################################
