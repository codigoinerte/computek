...
switch ($get_action) {
    case 'new':    	
		...
		$array_id = $datos_registro->insertar_registro($_item_nombre, $_item_url, "", $_item_resumen, $_item_descripcion, $_item_orden, $_item_tipo, $_item_estado, 1, 0, $fecha_creacion, $fecha_creacion);
    ...
    case 'edit':
    	...
    	$datos_registro->actualizar_registro($get_id, $_item_nombre, $_item_url,"", $_item_resumen,$_item_descripcion,$_item_orden,$_item_estado,0,$fecha_creacion);
