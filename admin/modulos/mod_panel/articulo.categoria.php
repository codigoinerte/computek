...
$url_guardar = "guardar_categoria_articulo();";

$url_form_guardar = URL_WEB_ADMIN."modulos/$get_modulo/scripts/articulo.categoria.script.php";
...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Registro categorias</h1>
</div>
...
{
	include URL_ROOT_ADMIN."modulos/mod_panel/ajax/listado.registro.categoria.php";
}
			  ...
			  <div class="panel panel-default panel-form">
				...
				<div class="panel-body" >
					<?php
						...
						layers(1, "Nombre", "nombre", "Ingrese el nombre de la categoría", "", $item_nombre, $onclick1);
						layers(2, "Página", "pagina", "Seleccione la pagina", $array_paginas, $item_idpagina); 
