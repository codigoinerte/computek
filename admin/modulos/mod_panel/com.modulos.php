...
$url_guardar = "guardar_modulos();";
$url_form_guardar = URL_WEB_ADMIN."modulos/$get_modulo/scripts/com.modulos.script.php";
...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Modulos</h1>
</div>
...
{
	include URL_ROOT_ADMIN."modulos/mod_panel/ajax/listado.com.modulos.php";
}
			  ...
			  <div class="panel panel-default panel-form">
				...
				<div class="panel-body" >
					<?php 						
						...
						layers(15, "Iconos", "resumen", "Ingrese el icono del registro", "", $item_resumen);
