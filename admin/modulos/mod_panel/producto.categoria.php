...
$url_form_guardar = URL_WEB_ADMIN."modulos/$get_modulo/scripts/producto.categoria.script.php";
...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Producto categorias</h1>
</div>
...
{
	include URL_ROOT_ADMIN."modulos/mod_panel/ajax/listado.producto.categoria.php";
}
