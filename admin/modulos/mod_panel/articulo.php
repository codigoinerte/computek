...
$url_form_guardar = URL_WEB_ADMIN."modulos/$get_modulo/scripts/articulo.script.php";
...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">Registro articulos</h1>
</div>
...
{
	include URL_ROOT_ADMIN."modulos/mod_panel/ajax/listado.registro.articulo.php";
}
