...
$url_root_admin = substr($_SERVER['SCRIPT_FILENAME'], 0, -strlen($_SERVER['PHP_SELF']))."/";
/*
if($_SERVER["SERVER_NAME"] == "localhost")
{
	$path = (strtoupper(substr(PHP_OS, 0, 3)) === "WIN") ? "\\" : "/";
	$replace = explode($path, dirname(__file__));
	$dir = $replace[count($replace)-4]."/";
	$url_root=$url_root_admin.$dir;
    $url_root_admin= $url_root_admin.$dir."admin/";
}
...
$config['tempDirectory'] = $url_root_admin.'images/';
#$config['tempDirectory'] = sys_get_temp_dir();
